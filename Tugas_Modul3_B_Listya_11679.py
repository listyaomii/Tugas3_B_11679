...
st.markdown("""
    ...
    """, unsafe_allow_html=True)
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1679</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r"D:\coolyeah\semester5\ml\Supervised Learning (Praktek) (1)\Model Suprevised Learning (Praktek)\Tugas3_B_11679"
